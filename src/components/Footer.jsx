          ...
          <div className="grid md:grid-cols-12 gap-8 lg:gap-20 mb-8 md:mb-12">
            ...
            <div className="md:col-span-4 lg:col-span-5">
              ...
              <div className="text-gray-400">
                Unearth our collection of dark jokes that celebrate the twisted
                art of hilarity. Here, laughter rules – so buckle up for a wild
                ride into the darker side of funny!
              </div>
            </div>
            ...
            <div className="md:col-span-8 lg:col-span-7 grid sm:grid-cols-3 gap-8">
              ...
              <div className="text-sm text-end">
                ...
                <ul>
                  <li className="mb-1">
                    <a
                      href="https://github.com/Yapac/Dark-jokes-heaven"
                      className="text-gray-400 hover:text-gray-100 transition duration-150 ease-in-out"
                      target="_blank"
                    >
                      Code source
